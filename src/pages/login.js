      ...
      <div class="[box-shadow:rgba(149,157,165,0.3)_0px_4px_18px] max-w-3xl max-md:max-w-lg rounded-lg p-7">
        ...
        <div class="grid md:grid-cols-2 items-center gap-8">
          ...
          <form className={`md:max-w-md w-full mx-auto ${errors.form ? 'animate-shake' : ''}`} onSubmit={handleLoginClick}>
            <div class="mb-8">
              <h1 class="text-4xl font-bold font-mono text-green-600">Sign in</h1>
            </div>
            <div>
              <p class='text-sm text-gray-950 mb-1 font-mono'>Voter ID</p>
              <div class="relative flex items-center">
                <input name="voter_id" type="text" required class="w-full text-sm border rounded-md border-blue-300 focus:border-blue-600 pr-8 px-2 py-3 outline-none font-mono mb-2" placeholder="Enter your Voter ID" value={voters_id} onChange={(e) => setVotersId(e.target.value)} />
            ...
            <div class="mt-1">
              <p class='text-sm text-gray-950 mb-1 font-mono'>Password</p>
              <div class="relative flex items-center">
                <input name="password" type="password" required class="w-full text-sm border rounded-md border-gray-300 focus:border-blue-600 pr-8 px-2 py-3 outline-none font-mono" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
            ...
            {errors.form && <p className="text-red-500 text-xs mt-1 border rounded-md border-red-300 px-2 py-1 text-center">{errors.form}</p>}
            </div>
          </form>
        </div>
      </div>
