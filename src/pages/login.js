      ...
      <div class="relative z-10 [box-shadow:rgba(149,157,165,0.3)_0px_4px_18px] max-w-3xl max-md:max-w-lg rounded-lg p-7 bg-white">
        ...
        <div class="grid md:grid-cols-2 items-center gap-8">
          ...
          <form className={`md:max-w-md w-full mx-auto ${errors.form ? 'animate-shake' : ''}`} onSubmit={handleLoginClick}>
            <div class="mb-8">
              <h1 class="text-4xl font-medium font-sentient text-green-600">Sign in</h1>
            </div>
            <div>
              <RequiredLabel>Voter ID</RequiredLabel>
              <div class="relative flex items-center">
                <Mail className="absolute left-3 top-6 -translate-y-1/2 text-gray-400 w-4 h-4"/>
                <input name="voter_id" type="text" maxLength={12} required class="w-full text-sm border rounded-md border-blue-300 focus:border-blue-600 pl-10 pr-8 px-2 py-3 outline-none font-light font-sentient mb-2" placeholder="Enter your Voter ID" value={voters_id} onChange={(e) => setVotersId(e.target.value)} />
                  <defs>
            ...
            <div class="mt-1">
              ...
              <div class="relative flex items-center">
                <KeyRound className="absolute left-3 top-6 -translate-y-1/2 text-gray-400 w-4 h-4"/>
                <input name="password" type="password" required class="w-full text-sm pl-10 border rounded-md border-gray-300 focus:border-blue-600 pr-8 px-2 py-3 outline-none font-light font-sentient" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
            ...
            <div class="mt-2 mb-4">
              <button type="submit" class="w-full shadow-xl py-2 px-4 text-[15px] font-medium font-sentient tracking-wide rounded-md cursor-pointer font-serif text-white bg-green-600 hover:bg-green-900 focus:outline-none">
                Sign in
              </button>
            </div>
