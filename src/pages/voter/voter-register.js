      ...
      <form>
        <div class="grid sm:grid-cols-1 gap-8">
          <div>
            ...
            class="bg-slate-100 w-full text-slate-900 text-sm px-4 py-3 rounded-md focus:bg-transparent outline-green-500 transition-all" placeholder="Enter Voter ID" />
          </div>
          <div>
          ...
          <div>
            ...
            class="bg-slate-100 w-full text-slate-900 text-sm px-4 py-3 rounded-md focus:bg-transparent outline-green-500 transition-all" placeholder="Enter precinct number" />
          </div>
          <div>
            ...
            class="bg-slate-100 w-full text-slate-900 text-sm px-4 py-3 rounded-md focus:bg-transparent outline-green-500 transition-all" placeholder="Enter password" />
            <button type="button"
            onClick={() => setShowPassword((prev) => !prev)}>{showPassword ? "Hide" : "Show"}</button>
          </div>
        </div>
        <div class="mt-12">
          <button type="button" onClick={handleRegister} class="mx-auto block min-w-32 py-3 px-6 text-sm font-medium tracking-wider rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none cursor-pointer">
            Register
          </button>
        </div>
        { success && (
